...
const Footer = ({footer}) => {
  return (
   ...
   <div className="PreFooter">
      ...
      <div>
          <a href='https://www.mi.com/in/service/replacefaq/'> {repeatIcon} </a> 
          <p>
          ...
          <div>
              <a href='https://www.mi.com/in/service/paymentfaq/'> {shieldIcon} </a> <p>
          ...
          <div>
            <a href='https://www.mi.com/in/service/repair/'>{mapIcon}</a> <p>
   ...
   <div className="PreFooter2">
        ...
        <div>
            ...
            <div>
                ...
                <a href='https://www.youtube.com/user/MiIndiaOfficial'>  {youtubeIcon}   </a>
                <a href='https://www.instagram.com/xiaomiindia/'>  {instagramIcon} </a>
            ...
            <div className="footer">
                    ...
                    <div>
                        ...
                        <button> <a className='chat' href="https://in.chat.kefu.mi.com/page/index/v2?tag=in&token=aW4jNTAwMCNpbi53ZWIubWkjd2Vic2l0ZSNnb29kc0RldGFpbA==&groupId=P0&locale=en&closedshow=1">CHAT NOW</a></button>
                    </div>
